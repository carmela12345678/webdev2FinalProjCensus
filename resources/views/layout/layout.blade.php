...
<html  lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <title>Digitalized Data Census</title>
        <meta charset="utf-8">
    ...
    <body  class="antialiased">
        <div class="background"><img src="Logo.png" style="border-radius:5px; margin-top:20px; margin-bottom:20px; margin-left:20px;"></div>
